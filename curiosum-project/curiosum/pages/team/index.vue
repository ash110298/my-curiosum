  ...
  <div>
    ...
    <div class="profile-page" v-if="userTeam">
      <section class="section my-0">
        <div class="container">
          <card class="card-profile mt-0" no-body shadow>
            <div class="px-4 text-dark">
              ...
              <div class="mt-0 mt-md-2 pt-lg-2 border-primary ">
                <div class="row mx-0 justify-content-center justify-content-md-between">
                  <div class="card col-md-4 mt-1 border-white">
        ...
        <div class="my-4 py-2 border-top px-3 " v-if="userTeam.events && userTeam.events.length > 0">
              ...
              <div class="my-1 py-2 border-white px-3" v-if="!!(userTeam.users && userTeam.users.length > 0)">
                  ...
                  <b-col :key="user.id" lg="2" md="3" sm="4" v-bind:class="{'team-captain order-first': !!isCaptain(userTeam.captain, user._id), 'order-2': !isCaptain(userTeam.captain, user._id)}" v-for="user in userTeam.users">
                    <card class="team-user-profiles my-1" no-body tag="article">
                      <div class="text-center">
                        <img alt="User profile" class="rounded-circle" style="height: 30px; width: 30px; object-fit: cover;" v-lazy="user.profile.picture" />
                        <div class="my-2">
...
export default {
  data() {
    return {
    url1: 'https://drive.google.com/drive/u/3/folders/1J88BQXVpPA3kg0nE7y14cIw9ynITJn8Z',
      inviteLink: "",
      modalShow: false,
      userTeam: null,
      joinTeamModalError: "",
